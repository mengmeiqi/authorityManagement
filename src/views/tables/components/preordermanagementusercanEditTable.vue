      ...
      on: {
        click: () => {
          if (!currentRow.editting) {
            ...
            axios
              .post(
                "http://www.wuyangdata.com:60001/tbeforehandorder/updatetbo",
                {
                  id:parseInt(vm.thisTableData[index].id),
                  compactNum: vm.thisTableData[index].compactNum,
                  beforehandNum: vm.thisTableData[index].beforehandNum,
                  concludeSignPlace: vm.thisTableData[index].concludeSignPlace,
                }
              )
              .then(function(res) {
    ...
    "Poptip",
    {
      ...
      on: {
        "on-ok": () => {
          ...
          axios
            .post(
              "http://www.wuyangdata.com:60001/tbeforehandorder/deletetbo",
              {
